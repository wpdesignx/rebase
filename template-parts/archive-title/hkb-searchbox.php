...
<form class="hkb-site-search search-form" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label class="hkb-screen-reader-text screen-reader-text" for="s"><?php esc_html_e( 'Search For', 'rebase' ); ?></label>
	...
	<?php } ?>
	<button class="hkb-site-search__button search-submit" type="submit"><span><?php esc_html_e( 'Search', 'rebase' ); ?></span></button>
	<div class="base-search-icon-wrap"><?php webapp()->print_icon( 'search', '', false ); ?></div>
</form>
