...
<ul id="bbp-topic-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(); ?>>
	<li class="bbp-topic-title">
		...
		<p class="bbp-topic-meta entry-meta">
			...
			<span class="bbp-topic-started-by"><?php printf( esc_html__( 'Started by: %1$s', 'rebase' ), bbp_get_topic_author_link( array( 'size' => '14' ) ) ); ?></span>
			...
			<?php if ( ! bbp_is_single_forum() || ( bbp_get_topic_forum_id() !== bbp_get_forum_id() ) ) : ?>
				...
				<span class="bbp-topic-started-in"><?php printf( esc_html__( 'in: %1$s', 'rebase' ), '<a href="' . bbp_get_forum_permalink( bbp_get_topic_forum_id() ) . '">' . bbp_get_forum_title( bbp_get_topic_forum_id() ) . '</a>' ); ?></span>
			...
			<span class="bbpress-meta-replies">
				...
				<?php
				bbp_show_lead_topic()
				? esc_html_e( 'Replies', 'rebase' )
				: esc_html_e( 'Posts',   'rebase' );
				?>
			</span>
		</p>
