...
export const ProModules = () => {
	...
	return (
		<Fragment>
			{/* <h2 className="section-header">{ __( 'Do more with the Base Pro Addon', 'rebase' ) }</h2>
					...
					return (
						<div className="link-item locked-item">
							...
							<div className="link-item-foot">
								<a href={ `https://github.com/wpdesignx/rebase#premium/?utm_source=${ link.setting }&utm_campaign=theme-dash` } target="_blank">
									{ __( 'Learn More', 'rebase') }
								</a>
							</div>
						</div>
					);
