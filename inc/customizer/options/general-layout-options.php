...
$settings = array(
	'content_width' => array(
		...
		'priority'     => 20,
		'label'        => esc_html__( 'Content Max Width', 'rebase' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'content_edge_spacing' => array(
		...
		'section'      => 'general_layout',
		'priority'     => 20,
		'label'        => esc_html__( 'Content Left/Right Edge Spacing', 'rebase' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'content_spacing' => array(
		...
		'section'      => 'general_layout',
		'priority'     => 20,
		'label'        => esc_html__( 'Content Top and Bottom Spacing', 'rebase' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'content_narrow_width' => array(
		...
		'section'      => 'general_layout',
		'priority'     => 20,
		'label'        => esc_html__( 'Narrow Layout Content Max Width', 'rebase' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'info_general_single_boxed' => array(
		...
		'section'      => 'general_layout',
		'priority'     => 21,
		'label'        => esc_html__( 'Single Post Boxed', 'rebase' ),
		'settings'     => false,
	),
	'boxed_spacing' => array(
		'control_type' => 'base_range_control',
		'section'      => 'general_layout',
		'priority'     => 22,
		'label'        => esc_html__( 'Single Post Boxed Spacing', 'rebase' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'boxed_shadow' => array(
		...
		'section'      => 'general_layout',
		'priority'     => 22,
		'label'        => esc_html__( 'Single Post Boxed Shadow', 'rebase' ),
		'live_method'     => array(
			array(
				'type'     => 'css_boxshadow',
	...
	'boxed_border_radius' => array(
		...
		'section'      => 'general_layout',
		'priority'     => 22,
		'label'        => esc_html__( 'Single Post Boxed Border Radius', 'rebase' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.entry.single-entry',
	...
	'info_general_archive_boxed' => array(
		...
		'section'      => 'general_layout',
		'priority'     => 22,
		'label'        => esc_html__( 'Archive Grid Boxed', 'rebase' ),
		'settings'     => false,
	),
	'boxed_grid_spacing' => array(
		...
		'section'      => 'general_layout',
		'priority'     => 22,
		'label'        => esc_html__( 'Archive Grid Boxed Spacing', 'rebase' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'boxed_grid_shadow' => array(
		...
		'section'      => 'general_layout',
		'priority'     => 22,
		'label'        => esc_html__( 'Archive Grid Boxed Shadow', 'rebase' ),
		'live_method'     => array(
			array(
				'type'     => 'css_boxshadow',
	...
	'boxed_grid_border_radius' => array(
		...
		'section'      => 'general_layout',
		'priority'     => 22,
		'label'        => esc_html__( 'Archive Grid Boxed Border Radius', 'rebase' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.entry.loop-entry',
