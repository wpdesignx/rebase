...
$settings = array(
	...
	'info_transparent_logo_in_use' => array(
		...
		'section'      => 'title_tagline',
		'priority'     => 5,
		'description'        => esc_html__( '*NOTICE Custom transparent logo will show on pages that have the transparent header enabled. Change that in your transparent header settings.', 'rebase' ),
		'settings'     => false,
		'context'      => array(
			array(
				'setting' => '__current_tab',
	...
	'logo_layout' => array(
		...
		'label'        => esc_html__( 'Logo Layout', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'brand_typography' => array(
		...
		'section'      => 'title_tagline',
		'label'        => esc_html__( 'Site Title Font', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'brand_typography_color' => array(
		...
		'section'      => 'title_tagline',
		'label'        => esc_html__( 'Site Title Hover and Active Colors', 'rebase' ),
	...
	'brand_tag_typography' => array(
		'control_type' => 'base_typography_control',
		'section'      => 'title_tagline',
		'label'        => esc_html__( 'Site Tagline Font', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'logo_link_to_site_icon' => array(
		...
		'settings'     => false,
		'priority'     => 25,
		'label'        => esc_html__( 'Site Icon', 'rebase' ),
		'input_attrs'  => array(
	...
	'site_logo_link' => array(
		...
		'settings'     => false,
		'priority'     => 5,
		'label'        => esc_html__( 'Site Title and Logo Control', 'rebase' ),
		'input_attrs'  => array(
			'section' => 'title_tagline',
		),
	),
	'post_archive_home_title' => array(
		...
		'label'        => esc_html__( 'Show site name for page title', 'rebase' ),
		'context'      => array(
			array(
