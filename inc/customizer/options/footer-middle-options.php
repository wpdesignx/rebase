...
$settings = array(
	...
	'footer_middle_link_colors' => array(
		...
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.site-footer .site-middle-footer-wrap .site-footer-row-container-inner a:not(.button):not(.wp-block-button__link):not(.wp-element-button)',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'color',
			),
			array(
				'type'     => 'css',
				'selector' => '.site-footer .site-middle-footer-wrap .site-footer-row-container-inner a:not(.button):not(.wp-block-button__link):not(.wp-element-button):hover',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'hover',
			),
	...
	'footer_middle_background' => array(
		...
		'section'      => 'footer_middle',
		'label'        => esc_html__( 'Middle Row Background', 'rebase' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Middle Row Background', 'rebase' ),
		),
	),
