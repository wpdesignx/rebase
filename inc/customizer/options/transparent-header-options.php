...
$base_trans_settings = array(
	...
	'transparent_header_enable' => array(
		...
		'label'        => esc_html__( 'Enable Transparent Header?', 'rebase' ),
		'transport'    => 'refresh',
	),
	'transparent_header_archive' => array(
		...
		'label'        => esc_html__( 'Disable Search and Archives?', 'rebase' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
	...
	'transparent_header_page' => array(
		...
		'label'        => esc_html__( 'Disable on Pages?', 'rebase' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
				'setting'  => 'transparent_header_enable',
	...
	'transparent_header_post' => array(
		...
		'label'        => esc_html__( 'Disable on Posts?', 'rebase' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
				'setting'  => 'transparent_header_enable',
	...
	'transparent_header_device' => array(
		...
		'label'        => esc_html__( 'Enable for:', 'rebase' ),
		'context'      => array(
			array(
				'setting'  => 'transparent_header_enable',
				'operator' => '=',
	...
	'transparent_header_custom_logo' => array(
		...
		'label'        => esc_html__( 'Different Logo for Transparent Header?', 'rebase' ),
		'context'      => array(
			array(
				'setting'    => 'logo_layout',
	...
	'transparent_header_logo' => array(
		...
		'mime_type'    => 'image',
		'default'      => '',
		'label'        => esc_html__( 'Transparent Header Logo', 'rebase' ),
		'context'      => array(
			array(
				'setting'    => 'logo_layout',
				'operator'   => 'sub_object_contains',
	...
	'transparent_header_background' => array(
		...
		'section'      => 'transparent_header_design',
		'label'        => esc_html__( 'Transparent Header Background', 'rebase' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Transparent Header Background', 'rebase' ),
		),
	),
	...
	$base_trans_settings = array_merge(
		...
		array(
			'transparent_header_product' => array(
				...
				'label'        => esc_html__( 'Disable on Products?', 'rebase' ),
				'transport'    => 'refresh',
				'context'      => array(
					array(
						'setting'  => 'transparent_header_enable',
...
foreach ( $base_trans_post_types as $post_type_item ) {
	...
	if ( ! in_array( $post_type_name, $ignore_type, true ) ) {
		...
		$base_trans_extras_post_types[ 'transparent_header_' . $post_type_name ] = array(
			...
			'priority'     => 5,
			'default'      => true,
			'label'        => esc_html__( 'Disable on', 'rebase' ) . ' ' . $post_type_label . '?',
			'transport'    => 'refresh',
			'context'      => array(
				array(
					'setting'  => 'transparent_header_enable',
