...
<div class="base-compontent-custom fonts-flush-button wp-clearfix">
	<span class="customize-control-title">
		<?php esc_html_e( 'Flush Local Fonts Cache', 'rebase' ); ?>
	</span>
	<span class="description customize-control-description">
		<?php esc_html_e( 'Click the button to reset the local fonts cache', 'rebase' ); ?>
	</span>
	<input type="button" class="button base-flush-local-fonts-button" name="base-flush-local-fonts-button" value="<?php esc_attr_e( 'Flush Local Font Files', 'rebase' ); ?>" />
</div>
<?php
...
Theme_Customizer::add_settings(
	array(
		'enable_scroll_to_id' => array(
			...
			'label'        => esc_html__( 'Enable Scroll To ID', 'rebase' ),
		),
		'lightbox' => array(
			'control_type' => 'base_switch_control',
			'sanitize'     => 'base_sanitize_toggle',
			...
			'label'        => esc_html__( 'Enable Lightbox', 'rebase' ),
		),
		'load_fonts_local' => array(
			...
			'label'        => esc_html__( 'Load Google Fonts Locally', 'rebase' ),
		),
		'preload_fonts_local' => array(
			...
			'label'        => esc_html__( 'Preload Local Fonts', 'rebase' ),
			'context'      => array(
				array(
		...
		'enable_preload' => array(
			...
			'label'        => esc_html__( 'Enable CSS Preload', 'rebase' ),
		),
	)
);
