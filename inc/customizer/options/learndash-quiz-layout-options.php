...
$settings = array(
	...
	'sfwd-quiz_title' => array(
		...
		'section'      => 'sfwd_quiz_layout',
		'priority'     => 3,
		'default'      => webapp()->default( 'sfwd-quiz_title' ),
	...
	'sfwd-quiz_title_layout' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 4,
		'default'      => webapp()->default( 'sfwd-quiz_title_layout' ),
		'context'      => array(
			array(
	...
	'sfwd-quiz_title_inner_layout' => array(
		...
		'section'      => 'sfwd_quiz_layout',
		'priority'     => 4,
		'default'      => webapp()->default( 'sfwd-quiz_title_inner_layout' ),
	...
	'sfwd-quiz_title_align' => array(
		...
		'priority'     => 4,
		'default'      => webapp()->default( 'sfwd-quiz_title_align' ),
		'context'      => array(
			array(
				'setting'    => 'sfwd-quiz_title',
				'operator'   => '=',
	...
	'sfwd-quiz_title_height' => array(
		...
		'default'      => webapp()->default( 'sfwd-quiz_title_height' ),
		'input_attrs'  => array(
			'min'     => array(
				'px'  => 10,
				'em'  => 1,
	...
	'sfwd-quiz_title_elements' => array(
		...
		'section'      => 'sfwd_quiz_layout',
		'priority'     => 6,
		'default'      => webapp()->default( 'sfwd-quiz_title_elements' ),
	...
	'sfwd-quiz_title_font' => array(
		...
		'section'      => 'sfwd_quiz_layout_design',
		'label'        => esc_html__( 'Quiz Title Font', 'rebase' ),
		'default'      => webapp()->default( 'sfwd-quiz_title_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
	...
	'sfwd-quiz_title_breadcrumb_color' => array(
		...
		'default'      => webapp()->default( 'sfwd-quiz_title_breadcrumb_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.sfwd-quiz-title .base-breadcrumbs',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'color',
			),
			array(
				'type'     => 'css',
				'selector' => '.sfwd-quiz-title .base-breadcrumbs a:hover',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'hover',
			),
	...
	'sfwd-quiz_title_breadcrumb_font' => array(
		...
		'default'      => webapp()->default( 'sfwd-quiz_title_breadcrumb_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
				'selector' => '.sfwd-quiz-title .base-breadcrumbs',
	...
	'sfwd-quiz_title_background' => array(
		...
		'section'      => 'sfwd_quiz_layout_design',
		'label'        => esc_html__( 'Quiz Above Area Background', 'rebase' ),
		'default'      => webapp()->default( 'sfwd-quiz_title_background' ),
		'context'      => array(
			array(
				'setting'    => 'sfwd-quiz_title',
				'operator'   => '=',
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Quiz Title Background', 'rebase' ),
		),
	),
	'sfwd-quiz_title_featured_image' => array(
		...
		'sanitize'     => 'base_sanitize_toggle',
		'section'      => 'sfwd_quiz_layout_design',
		'default'      => webapp()->default( 'sfwd-quiz_title_featured_image' ),
	...
	'sfwd-quiz_title_overlay_color' => array(
		...
		'default'      => webapp()->default( 'sfwd-quiz_title_overlay_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'sfwd-quiz_title_border' => array(
		...
		'default'      => webapp()->default( 'sfwd-quiz_title_border' ),
		'context'      => array(
			array(
				'setting'    => 'sfwd-quiz_title',
				'operator'   => '=',
	...
	'sfwd-quiz_layout' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 10,
		'default'      => webapp()->default( 'sfwd-quiz_layout' ),
		'input_attrs'  => array(
			'layout' => array(
				'normal' => array(
	...
	'sfwd-quiz_sidebar_id' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 10,
		'default'      => webapp()->default( 'sfwd-quiz_sidebar_id' ),
		'input_attrs'  => array(
	...
	'sfwd-quiz_content_style' => array(
		...
		'priority'     => 10,
		'default'      => webapp()->default( 'sfwd-quiz_content_style' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
	...
	'sfwd-quiz_vertical_padding' => array(
		...
		'priority'     => 10,
		'default'      => webapp()->default( 'sfwd-quiz_vertical_padding' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
				'selector' => 'body.single-sfwd-quiz',
	...
	'sfwd-quiz_feature' => array(
		...
		'section'      => 'sfwd_quiz_layout',
		'priority'     => 20,
		'default'      => webapp()->default( 'sfwd-quiz_feature' ),
	...
	'sfwd-quiz_feature_position' => array(
		...
		'priority'     => 20,
		'transport'    => 'refresh',
		'default'      => webapp()->default( 'sfwd-quiz_feature_position' ),
		'context'      => array(
			array(
	...
	'sfwd-quiz_feature_ratio' => array(
		...
		'priority'     => 20,
		'default'      => webapp()->default( 'sfwd-quiz_feature_ratio' ),
		'context'      => array(
			array(
				'setting'    => 'sfwd-quiz_feature',
				'operator'   => '=',
	...
	'sfwd-quiz_background' => array(
		...
		'default'      => webapp()->default( 'sfwd-quiz_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css_background',
				'selector' => 'body.single-sfwd-quiz',
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Quiz Background', 'rebase' ),
		),
	),
	'sfwd-quiz_content_background' => array(
		...
		'default'      => webapp()->default( 'sfwd-quiz_content_background' ),
		'live_method'  => array(
			array(
				'type'     => 'css_background',
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Quiz Content Background', 'rebase' ),
		),
	),
);
