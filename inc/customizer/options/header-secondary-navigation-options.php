...
$settings = array(
	...
	'secondary_navigation_link' => array(
		...
		'settings'     => false,
		'priority'     => 5,
		'label'        => esc_html__( 'Select Menu', 'rebase' ),
		'context'      => array(
			array(
	...
	'secondary_navigation_spacing' => array(
		...
		'section'      => 'secondary_navigation',
		'priority'     => 5,
		'label'        => esc_html__( 'Items Spacing', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'secondary_navigation_stretch' => array(
		...
		'label'        => esc_html__( 'Stretch Menu?', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'secondary_navigation_fill_stretch' => array(
		...
		'label'        => esc_html__( 'Fill and Center Menu Items?', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'secondary_navigation_style' => array(
		...
		'label'        => esc_html__( 'Navigation Style', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
		...
		'input_attrs'  => array(
			'layout' => array(
				'standard' => array(
					'tooltip' => __( 'Standard', 'rebase' ),
					'name'    => __( 'Standard', 'rebase' ),
					'icon'    => '',
				),
				'fullheight' => array(
					'tooltip' => __( 'Menu items are full height', 'rebase' ),
					'name'    => __( 'Full Height', 'rebase' ),
					'icon'    => '',
				),
				'underline' => array(
					'tooltip' => __( 'Underline Hover/Active', 'rebase' ),
					'name'    => __( 'Underline', 'rebase' ),
					'icon'    => '',
				),
				'underline-fullheight' => array(
					'tooltip' => __( 'Full Height Underline Hover/Active', 'rebase' ),
					'name'    => __( 'Full Height Underline', 'rebase' ),
					'icon'    => '',
				),
			),
			'responsive' => false,
	...
	'secondary_navigation_vertical_spacing' => array(
		'control_type' => 'base_range_control',
		'section'      => 'secondary_navigation',
		'label'        => esc_html__( 'Items Top and Bottom Padding', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'secondary_navigation_background' => array(
		'control_type' => 'base_color_control',
		'section'      => 'secondary_navigation',
		'label'        => esc_html__( 'Navigation Background', 'rebase' ),
	...
	'secondary_navigation_parent_active' => array(
		...
		'label'        => esc_html__( 'Make Parent of Current Menu Item Active?', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'secondary_navigation_typography' => array(
		...
		'section'      => 'secondary_navigation',
		'label'        => esc_html__( 'Navigation Font', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'info_secondary_submenu' => array(
		...
		'section'      => 'secondary_navigation',
		'priority'     => 20,
		'label'        => esc_html__( 'Dropdown Options', 'rebase' ),
		'settings'     => false,
	),
