...
$settings = array(
	...
	'header_main_background' => array(
		...
		'section'      => 'header_main',
		'label'        => esc_html__( 'Main Row Background', 'rebase' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Main Row Background', 'rebase' ),
		),
	),
	...
	'header_main_trans_background' => array(
		'control_type' => 'base_background_control',
		'section'      => 'header_main',
		'label'        => esc_html__( '(When Transparent Header) Main Row Background', 'rebase' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Transparent Header Main Row Background', 'rebase' ),
		),
	),
);
