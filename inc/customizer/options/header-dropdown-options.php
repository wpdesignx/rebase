...
Theme_Customizer::add_settings(
	array(
		...
		'dropdown_navigation_color' => array(
			...
			'section'      => 'dropdown_navigation_design',
			'label'        => esc_html__( 'Dropdown Colors', 'rebase' ),
		...
		'dropdown_navigation_background' => array(
			...
			'section'      => 'dropdown_navigation_design',
			'priority'     => 20,
			'label'        => esc_html__( 'Dropdown Background', 'rebase' ),
		...
		'dropdown_navigation_divider' => array(
			...
			'section'      => 'dropdown_navigation_design',
			'priority'     => 20,
			'label'        => esc_html__( 'Item Divider', 'rebase' ),
		...
		'dropdown_navigation_typography' => array(
			...
			'section'      => 'dropdown_navigation_design',
			'priority'     => 20,
			'label'        => esc_html__( 'Dropdown Font', 'rebase' ),
		...
		'dropdown_navigation_shadow' => array(
			...
			'section'      => 'dropdown_navigation_design',
			'priority'     => 20,
			'label'        => esc_html__( 'Dropdown Shadow', 'rebase' ),
			'live_method'     => array(
				array(
					'type'     => 'css_boxshadow',
		...
		'dropdown_navigation_reveal' => array(
			...
			'label'        => esc_html__( 'Dropdown Reveal', 'rebase' ),
			'live_method'     => array(
				array(
					'type'     => 'class',
			...
			'input_attrs'  => array(
				'layout' => array(
					...
					'fade-up' => array(
						'name'    => __( 'Fade Up', 'rebase' ),
					),
					'fade-down' => array(
						'name'    => __( 'Fade Down', 'rebase' ),
					),
				),
				'responsive' => false,
			),
		...
		'dropdown_navigation_width' => array(
			...
			'section'      => 'dropdown_navigation',
			'priority'     => 20,
			'label'        => esc_html__( 'Dropdown Width', 'rebase' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
		...
		'dropdown_navigation_vertical_spacing' => array(
			...
			'section'      => 'dropdown_navigation',
			'priority'     => 20,
			'label'        => esc_html__( 'Dropdown Items Vertical Spacing', 'rebase' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '.header-navigation .header-menu-container ul ul li.menu-item > a',
