...
$settings = array(
	...
	'header_search_label' => array(
		...
		'label'        => esc_html__( 'Search Label', 'rebase' ),
		'context'      => array(
			array(
	...
	'header_search_label_visiblity' => array(
		...
		'label'        => esc_html__( 'Search Label Visibility', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'header_search_icon' => array(
		...
		'label'        => esc_html__( 'Search Icon', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'header_search_style' => array(
		...
		'label'        => esc_html__( 'Search Style', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'header_search_border' => array(
		...
		'section'      => 'header_search',
		'label'        => esc_html__( 'Search Border', 'rebase' ),
	...
	'header_search_color' => array(
		...
		'section'      => 'header_search',
		'label'        => esc_html__( 'Search Colors', 'rebase' ),
	...
	'header_search_background' => array(
		'control_type' => 'base_color_control',
		'section'      => 'header_search',
		'label'        => esc_html__( 'Search Background', 'rebase' ),
	...
	'header_search_typography' => array(
		...
		'section'      => 'header_search',
		'label'        => esc_html__( 'Label Font', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'header_search_padding' => array(
		...
		'label'        => esc_html__( 'Search Padding', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'info_search_modal' => array(
		...
		'section'      => 'header_search',
		'priority'     => 20,
		'label'        => esc_html__( 'Modal Options', 'rebase' ),
		'settings'     => false,
		'context'      => array(
			array(
				'setting' => '__current_tab',
	...
	'header_search_modal_color' => array(
		...
		'section'      => 'header_search',
		'priority'     => 20,
		'label'        => esc_html__( 'Text Colors', 'rebase' ),
		...
		'input_attrs'  => array(
			'colors' => array(
				...
				'hover' => array(
					'tooltip' => __( 'Focus/Hover Color', 'rebase' ),
					'palette' => true,
				),
			),
		),
	...
	'header_search_modal_background' => array(
		...
		'section'      => 'header_search',
		'priority'     => 20,
		'label'        => esc_html__( 'Modal Background', 'rebase' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Modal Background', 'rebase' ),
		),
	),
);
	...
	$settings = array_merge(
		...
		array(
			'header_search_woo' => array(
				...
				'label'        => esc_html__( 'Search only Products?', 'rebase' ),
				'transport'    => 'refresh',
				'context'      => array(
					array(
						'setting' => '__current_tab',
