...
$settings = array(
	...
	'mobile_navigation_background' => array(
		...
		'section'      => 'mobile_navigation',
		'priority'     => 20,
		'label'        => esc_html__( 'Background', 'rebase' ),
	...
	'mobile_navigation_vertical_spacing' => array(
		...
		'section'      => 'mobile_navigation',
		'priority'     => 20,
		'label'        => esc_html__( 'Items Vertical Spacing', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'mobile_navigation_collapse' => array(
		...
		'label'        => esc_html__( 'Collapse sub menu items?', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'mobile_navigation_parent_toggle' => array(
		...
		'label'        => esc_html__( 'Entire parent menu item expands sub menu', 'rebase' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
