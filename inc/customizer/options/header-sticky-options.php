...
$settings = array(
	...
	'header_sticky' => array(
		...
		'label'        => esc_html__( 'Enable Sticky Header?', 'rebase' ),
		'input_attrs'  => array(
			'options' => array(
				'no' => array(
					'name' => __( 'No', 'rebase' ),
				...
				'main' => array(
					'name' => __( 'Yes - Only Main Row', 'rebase' ),
				),
				'top_main' => array(
					'name' => __( 'Yes - Top Row & Main Row', 'rebase' ),
				),
				'top_main_bottom' => array(
					'name' => __( 'Yes - Whole Header', 'rebase' ),
				),
				'top' => array(
					'name' => __( 'Yes - Only Top Row', 'rebase' ),
				),
				'bottom' => array(
					'name' => __( 'Yes - Only Bottom Row', 'rebase' ),
				),
			),
		),
	),
	'header_reveal_scroll_up' => array(
		...
		'label'        => esc_html__( 'Enable Reveal Sticky on Scroll up', 'rebase' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
	...
	'header_sticky_shrink' => array(
		...
		'label'        => esc_html__( 'Enable Main Row Shrinking', 'rebase' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
				'setting'  => 'header_sticky',
	...
	'header_sticky_main_shrink' => array(
		...
		'section'      => 'header_sticky',
		'label'        => esc_html__( 'Main Row Shrink Height', 'rebase' ),
		'context'      => array(
			array(
	...
	'header_sticky_custom_logo' => array(
		...
		'label'        => esc_html__( 'Different Logo for Stuck Header?', 'rebase' ),
		'context'      => array(
			array(
				'setting'    => 'logo_layout',
	...
	'header_sticky_logo' => array(
		...
		'mime_type'    => 'image',
		'default'      => '',
		'label'        => esc_html__( 'Stuck Header Logo', 'rebase' ),
		'context'      => array(
			array(
				'setting'    => 'logo_layout',
				'operator'   => 'sub_object_contains',
	...
	'header_sticky_logo_width' => array(
		'control_type' => 'base_range_control',
		'section'      => 'header_sticky',
		'label'        => esc_html__( 'Logo Max Width', 'rebase' ),
		'description'  => esc_html__( 'Define the maxium width for the logo', 'rebase' ),
		'context'      => array(
			array(
				'setting'  => 'header_sticky',
				'operator' => '!=',
	...
	'info_mobile_header_sticky' => array(
		...
		'section'      => 'header_sticky',
		'priority'     => 20,
		'label'        => esc_html__( 'Mobile Sticky', 'rebase' ),
		'settings'     => false,
	),
	'mobile_header_sticky' => array(
		...
		'label'        => esc_html__( 'Enable Sticky for Mobile?', 'rebase' ),
		'input_attrs'  => array(
			'options' => array(
				'no' => array(
					'name' => __( 'No', 'rebase' ),
	...
	'mobile_header_sticky_shrink' => array(
		...
		'label'        => esc_html__( 'Enabled Main Row Shrinking', 'rebase' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
				'setting'  => 'mobile_header_sticky',
	...
	'header_sticky_custom_mobile_logo' => array(
		...
		'label'        => esc_html__( 'Different Logo for Mobile?', 'rebase' ),
		'context'      => array(
			array(
				'setting'    => 'logo_layout',
				'operator'   => 'sub_object_contains',
	...
	'header_sticky_mobile_logo' => array(
		...
		'mime_type'    => 'image',
		'default'      => '',
		'label'        => esc_html__( 'Mobile Logo', 'rebase' ),
		'context'      => array(
			array(
				'setting'    => 'logo_layout',
				'operator'   => 'sub_object_contains',
	...
	'header_sticky_site_title_color' => array(
		...
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Site Title Color', 'rebase' ),
	...
	'header_sticky_navigation_color' => array(
		'control_type' => 'base_color_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Navigation Colors', 'rebase' ),
		...
		'input_attrs'  => array(
			'colors' => array(
				...
				'active' => array(
					'tooltip' => __( 'Active Color', 'rebase' ),
					'palette' => true,
				),
			),
		),
	...
	'header_sticky_navigation_background' => array(
		'control_type' => 'base_color_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Navigation Items Background', 'rebase' ),
		...
		'input_attrs'  => array(
			'colors' => array(
				...
				'active' => array(
					'tooltip' => __( 'Active Background', 'rebase' ),
					'palette' => true,
				),
			),
		),
	...
	'header_sticky_button_color' => array(
		'control_type' => 'base_color_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Button Colors', 'rebase' ),
		...
		'input_attrs'  => array(
			'colors' => array(
				...
				'background' => array(
					'tooltip' => __( 'Background', 'rebase' ),
					'palette' => true,
				),
				'backgroundHover' => array(
					'tooltip' => __( 'Background Hover', 'rebase' ),
					'palette' => true,
				),
				'border' => array(
					'tooltip' => __( 'Border', 'rebase' ),
					'palette' => true,
				),
				'borderHover' => array(
					'tooltip' => __( 'Border Hover', 'rebase' ),
					'palette' => true,
				),
			),
		),
	...
	'header_sticky_social_color' => array(
		'control_type' => 'base_color_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Social Colors', 'rebase' ),
	...
	'header_sticky_html_color' => array(
		'control_type' => 'base_color_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'HTML Colors', 'rebase' ),
		...
		'input_attrs'  => array(
			'colors' => array(
				...
				'link' => array(
					'tooltip' => __( 'Link Color', 'rebase' ),
					'palette' => true,
				),
				'hover' => array(
					'tooltip' => __( 'Link Hover', 'rebase' ),
					'palette' => true,
				),
			),
		),
	...
	'header_sticky_background' => array(
		...
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Sticky Header Background', 'rebase' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Sticky Header Background', 'rebase' ),
		),
	),
	'header_sticky_bottom_border' => array(
		'control_type' => 'base_border_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Sticky Bottom Border', 'rebase' ),
