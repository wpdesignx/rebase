...
$settings = array(
	...
	'footer_social_items' => array(
		...
		'label'        => esc_html__( 'Social Items', 'rebase' ),
		'partial'      => array(
			'selector'            => '.footer-social-wrap',
			'container_inclusive' => true,
			'render_callback'     => 'Base\footer_social',
	...
	'footer_social_show_label' => array(
		...
		'label'        => esc_html__( 'Show Icon Label?', 'rebase' ),
		'partial'      => array(
			'selector'            => '.footer-social-wrap',
			'container_inclusive' => true,
			'render_callback'     => 'Base\footer_social',
	...
	'footer_social_item_spacing' => array(
		...
		'section'      => 'footer_social',
		'label'        => esc_html__( 'Item Spacing', 'rebase' ),
	...
	'footer_social_style' => array(
		...
		'label'        => esc_html__( 'Social Style', 'rebase' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
	...
	'footer_social_brand' => array(
		...
		'label'        => esc_html__( 'Use Brand Colors?', 'rebase' ),
		'input_attrs'  => array(
			'options' => array(
				'' => array(
					'name' => __( 'No', 'rebase' ),
				...
				'onhover' => array(
					'name' => __( 'On Hover', 'rebase' ),
				),
				'untilhover' => array(
					'name' => __( 'Until Hover', 'rebase' ),
				),
			),
		),
	),
	...
	'footer_social_link_to_social_links' => array(
		...
		'settings'     => false,
		'priority'     => 25,
		'label'        => esc_html__( 'Set Social Links', 'rebase' ),
		'input_attrs'  => array(
