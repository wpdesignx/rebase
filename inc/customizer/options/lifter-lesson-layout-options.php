...
$settings = array(
	...
	'info_lesson_title' => array(
		...
		'section'      => 'lesson_layout',
		'priority'     => 2,
		'label'        => esc_html__( 'Lesson Title', 'rebase' ),
		'settings'     => false,
	),
	...
	'lesson_title' => array(
		...
		'label'        => esc_html__( 'Show Lesson Title?', 'rebase' ),
		'transport'    => 'refresh',
	),
	'lesson_title_layout' => array(
		'control_type' => 'base_radio_icon_control',
		'section'      => 'lesson_layout',
		'label'        => esc_html__( 'Lesson Title Layout', 'rebase' ),
		'transport'    => 'refresh',
		'priority'     => 4,
	...
	'lesson_title_align' => array(
		'control_type' => 'base_radio_icon_control',
		'section'      => 'lesson_layout',
		'label'        => esc_html__( 'Lesson Title Align', 'rebase' ),
		'priority'     => 4,
	...
	'lesson_title_font' => array(
		...
		'section'      => 'lesson_layout_design',
		'label'        => esc_html__( 'Lesson Title Font', 'rebase' ),
	...
	'lesson_title_background' => array(
		...
		'section'      => 'lesson_layout_design',
		'label'        => esc_html__( 'Lesson Above Area Background', 'rebase' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Lesson Title Background', 'rebase' ),
		),
	),
	...
	'info_lesson_layout' => array(
		...
		'section'      => 'lesson_layout',
		'priority'     => 10,
		'label'        => esc_html__( 'Lesson Layout', 'rebase' ),
		'settings'     => false,
	),
	...
	'lesson_sidebar_id' => array(
		...
		'section'      => 'lesson_layout',
		'label'        => esc_html__( 'Lesson Default Sidebar', 'rebase' ),
		'transport'    => 'refresh',
		'priority'     => 10,
	...
	'lesson_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Lesson Background', 'rebase' ),
		),
	),
	'lesson_content_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Lesson Content Background', 'rebase' ),
		),
	),
);
