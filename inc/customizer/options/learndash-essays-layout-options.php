...
$settings = array(
	...
	'info_essays_title' => array(
		...
		'section'      => 'sfwd_essays_layout',
		'priority'     => 2,
		'label'        => esc_html__( 'Essay Title', 'rebase' ),
		'settings'     => false,
	),
	...
	'sfwd-essays_title' => array(
		...
		'label'        => esc_html__( 'Show Essay Title?', 'rebase' ),
		'transport'    => 'refresh',
	),
	'sfwd-essays_title_layout' => array(
		'control_type' => 'base_radio_icon_control',
		'section'      => 'sfwd_essays_layout',
		'label'        => esc_html__( 'Essay Title Layout', 'rebase' ),
		'transport'    => 'refresh',
		'priority'     => 4,
	...
	'sfwd-essays_title_align' => array(
		'control_type' => 'base_radio_icon_control',
		'section'      => 'sfwd_essays_layout',
		'label'        => esc_html__( 'Essay Title Align', 'rebase' ),
		'priority'     => 4,
	...
	'sfwd-essays_title_font' => array(
		...
		'section'      => 'sfwd_essays_layout_design',
		'label'        => esc_html__( 'Essay Title Font', 'rebase' ),
	...
	'sfwd-essays_title_background' => array(
		...
		'section'      => 'sfwd_essays_layout_design',
		'label'        => esc_html__( 'Essay Above Area Background', 'rebase' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Essay Title Background', 'rebase' ),
		),
	),
	...
	'info_sfwd_essays_layout' => array(
		...
		'section'      => 'sfwd_essays_layout',
		'priority'     => 10,
		'label'        => esc_html__( 'Essay Layout', 'rebase' ),
		'settings'     => false,
	),
	...
	'sfwd-essays_sidebar_id' => array(
		...
		'section'      => 'sfwd_essays_layout',
		'label'        => esc_html__( 'Essay Default Sidebar', 'rebase' ),
		'transport'    => 'refresh',
		'priority'     => 10,
	...
	'sfwd-essays_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Essay Background', 'rebase' ),
		),
	),
	'sfwd-essays_content_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Essay Content Background', 'rebase' ),
		),
	),
);
