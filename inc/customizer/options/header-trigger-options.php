...
$settings = array(
	...
	'mobile_trigger_label' => array(
		...
		'label'        => esc_html__( 'Menu Label', 'rebase' ),
		'live_method'     => array(
			array(
				'type'     => 'html',
	...
	'mobile_trigger_icon' => array(
		...
		'label'        => esc_html__( 'Trigger Icon', 'rebase' ),
		'partial'      => array(
	...
	'mobile_trigger_style' => array(
		...
		'label'        => esc_html__( 'Trigger Style', 'rebase' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
	...
	'mobile_trigger_border' => array(
		...
		'section'      => 'mobile_trigger_design',
		'label'        => esc_html__( 'Trigger Border', 'rebase' ),
	...
	'mobile_trigger_color' => array(
		...
		'section'      => 'mobile_trigger_design',
		'label'        => esc_html__( 'Trigger Colors', 'rebase' ),
	...
	'mobile_trigger_typography' => array(
		...
		'section'      => 'mobile_trigger_design',
		'label'        => esc_html__( 'Trigger Font', 'rebase' ),
		'context'      => array(
			array(
	...
	'mobile_trigger_padding' => array(
		...
		'label'        => esc_html__( 'Trigger Padding', 'rebase' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.mobile-toggle-open-container .menu-toggle-open',
	...
	'info_link_drawer_container' => array(
		...
		'section'      => 'mobile_trigger',
		'priority'     => 20,
		'label'        => esc_html__( 'Drawer Container Options', 'rebase' ),
		'settings'     => false,
	),
