	...
	if ( ! in_array( $post_type_name, $ignore_type, true ) ) {
		...
		$settings = array(
			...
			'info_' . $post_type_name . '_title' => array(
				...
				'section'      => $post_type_name . '_layout',
				'priority'     => 2,
				'label'        => $post_type_label . ' ' . esc_html__( 'Title', 'rebase' ),
				'settings'     => false,
			),
			...
			$post_type_name . '_title' => array(
				...
				'label'        => esc_html__( 'Show Title?', 'rebase' ),
				'transport'    => 'refresh',
			),
			$post_type_name . '_title_layout' => array(
				'control_type' => 'base_radio_icon_control',
				'section'      => $post_type_name . '_layout',
				'label'        => $post_type_label . ' ' . esc_html__( 'Title Layout', 'rebase' ),
				'transport'    => 'refresh',
				'priority'     => 4,
			...
			$post_type_name . '_title_align' => array(
				'control_type' => 'base_radio_icon_control',
				'section'      => $post_type_name . '_layout',
				'label'        => $post_type_label . ' ' . esc_html__( 'Title Align', 'rebase' ),
				'priority'     => 4,
			...
			$post_type_name . '_title_font' => array(
				...
				'section'      => $post_type_name . '_layout_design',
				'label'        => $post_type_label . ' ' . esc_html__( 'Title Font', 'rebase' ),
			...
			$post_type_name . '_title_background' => array(
				...
				'section'      => $post_type_name . '_layout_design',
				'label'        => $post_type_label . ' ' . esc_html__( 'Title Background', 'rebase' ),
				...
				'input_attrs'  => array(
					'tooltip'  => $post_type_name . ' ' . __( 'Title Background', 'rebase' ),
				),
			),
			...
			'info_' . $post_type_name . '_layout' => array(
				...
				'section'      => $post_type_name . '_layout',
				'priority'     => 10,
				'label'        => $post_type_label . ' ' . esc_html__( 'Layout', 'rebase' ),
				'settings'     => false,
			),
			...
			$post_type_name . '_sidebar_id' => array(
				...
				'section'      => $post_type_name . '_layout',
				'label'        => esc_html__( 'Default Sidebar', 'rebase' ),
				'transport'    => 'refresh',
				'priority'     => 10,
			...
			$post_type_name . '_background' => array(
				...
				'input_attrs'  => array(
					'tooltip' => $post_type_label . ' ' . __( 'Background', 'rebase' ),
				),
			),
			$post_type_name . '_content_background' => array(
				...
				'input_attrs'  => array(
					'tooltip' => $post_type_label . ' ' . __( 'Content Background', 'rebase' ),
				),
			),
		);
		$add_extras = false;
		...
		$base_custom_post_type_archive_settings = array(
			...
			$post_type_name . '_archive_title_align' => array(
				'control_type' => 'base_radio_icon_control',
				'section'      => $post_type_name . '_archive',
				'label'        => esc_html__( 'Archive Title Align', 'rebase' ),
				'priority'     => 4,
			...
			$post_type_name . '_archive_title_background' => array(
				...
				'input_attrs'  => array(
					'tooltip'  => __( 'Title Background', 'rebase' ),
				),
			),
			...
			$post_type_name . '_archive_columns' => array(
				...
				'section'      => $post_type_name . '_archive',
				'priority'     => 10,
				'label'        => esc_html__( 'Archive Columns', 'rebase' ),
				'transport'    => 'refresh',
			...
			$post_type_name . '_archive_elements' => array(
				...
				'label'        => esc_html__( 'Item Elements', 'rebase' ),
				'transport'    => 'refresh',
				'settings'     => array(
			...
			$post_type_name . '_archive_background' => array(
				...
				'input_attrs'  => array(
					'tooltip' => __( 'Archive Background', 'rebase' ),
				),
			),
...
Theme_Customizer::add_settings(
	array( 
		'info_custom_post_types_placehoder' => array(
			...
			'priority'     => 10,
			'label'        => esc_html__( 'Custom Post Types', 'rebase' ),
			'settings'     => false,
		),
	)
);
