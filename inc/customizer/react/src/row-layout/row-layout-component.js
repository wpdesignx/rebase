	...
	constructor() {
		...
		let defaultParams = {
			desktop: {
				'column5': {
					'equal': {
						tooltip: __( 'Equal Width Columns', 'rebase' ),
						icon: 'fivecol',
					},
				},
				'column4': {
					...
					'left-forty': {
						tooltip: __( 'Left Heavy 40/20/20/20', 'rebase' ),
						icon: 'lfourforty',
					},
					'right-forty': {
						tooltip: __( 'Right Heavy 20/20/20/40', 'rebase' ),
						icon: 'rfourforty',
					},
				},
				'column3': {
					...
					'left-half': {
						tooltip: __( 'Left Heavy 50/25/25', 'rebase' ),
						icon: 'lefthalf',
					},
					'right-half': {
						tooltip: __( 'Right Heavy 25/25/50', 'rebase' ),
						icon: 'righthalf',
					},
					'center-half': {
						tooltip: __( 'Center Heavy 25/50/25', 'rebase' ),
						icon: 'centerhalf',
					},
					'center-wide': {
						tooltip: __( 'Wide Center 20/60/20', 'rebase' ),
						icon: 'widecenter',
					},
				},
				'column2': {
					...
					'left-golden': {
						tooltip: __( 'Left Heavy 66/33', 'rebase' ),
						icon: 'twoleftgolden',
					},
					'right-golden': {
						tooltip: __( 'Right Heavy 33/66', 'rebase' ),
						icon: 'tworightgolden',
					},
				},
				'column1': {
			...
			mobile: {
				'column5': {
					...
					'row': {
						tooltip: __( 'Collapse to Rows', 'rebase' ),
				...
				'column4': {
					...
					'two-grid': {
						tooltip: __( 'Two Column Grid', 'rebase' ),
						icon: 'grid',
					},
					'row': {
						tooltip: __( 'Collapse to Rows', 'rebase' ),
				...
				'column3': {
					...
					'first-row': {
						tooltip: __( 'First Row, Next Columns 100 - 50/50', 'rebase' ),
						icon: 'firstrow',
					},
					'last-row': {
						tooltip: __( 'Last Row, Previous Columns 50/50 - 100', 'rebase' ),
						icon: 'lastrow',
					},
					'row': {
						tooltip: __( 'Collapse to Rows', 'rebase' ),
