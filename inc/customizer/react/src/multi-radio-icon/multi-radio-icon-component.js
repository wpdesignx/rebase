...
class RadioIconComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			include: {
				logo_only: {
					tooltip: __( 'Logo Only', 'rebase' ),
					name: __( 'Logo', 'rebase' ),
				},
				logo_title: {
					tooltip: __( 'Logo & Title', 'rebase' ),
					name: __( 'Logo & Title', 'rebase' ),
				},
				logo_title_tagline: {
					tooltip: __( 'Logo, Title & Tagline', 'rebase' ),
					name: __( 'Logo, Title & Tagline', 'rebase' ),
				},
			},
			layout: {
				logo_only: {
				...
				logo_title: {
					...
					title_logo: {
						tooltip: __( 'Title - Logo', 'rebase' ),
						icon: Icons.titleLogo
					},
					top_logo_title: {
						tooltip: __( 'Top Logo - Title', 'rebase' ),
						icon: Icons.topLogoTitle
					},
					top_title_logo: {
						tooltip: __( 'Top Title - Logo', 'rebase' ),
				...
				logo_title_tagline: {
					...
					title_tag_logo: {
						tooltip: __( 'Title - Tagline - Logo', 'rebase' ),
						icon: Icons.titleTagLogo
					},
					top_logo_title_tag: {
						tooltip: __( 'Top Logo - Title - Tagline', 'rebase' ),
						icon: Icons.topLogoTitleTag
					},
					top_title_tag_logo: {
						tooltip: __( 'Top Title - Tagline - Logo', 'rebase' ),
						icon: Icons.topTitleTagLogo
					},
					top_title_logo_tag: {
						tooltip: __( 'Top Title - Logo - Tagline', 'rebase' ),
