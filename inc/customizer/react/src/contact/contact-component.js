...
class ContactComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			...
			'options': [
				{ value: 'phone', label: __( 'Phone', 'rebase' ), content: __( '444-546-8765', 'rebase' ) },
				{ value: 'hours', label: __( 'Hours', 'rebase' ), content: __( 'Mon - Fri: 8AM - 5PM', 'rebase' ) },
				{ value: 'email', label: __( 'Email', 'rebase' ), content: __( 'example@example.com', 'rebase' ) },
				{ value: 'location', label: __( 'Address', 'rebase' ), content: __( '4560 example street', 'rebase' ) },
			],
		};
				...
				{ undefined !== availibleContactOptions[0] && undefined !== availibleContactOptions[0].value && (
					<div className="base-contact-add-area base-social-add-area">
						{ this.state.isVisible && (
							<Popover position="top right" className="base-popover-color base-popover-contact" onClose={ toggleClose }>
