...
export const BaseColorPicker = ({ rgb, hex, hsv, hsl, onChange, renderers }) => {
  const styles = {
	picker: {
		width: 300,
		position: 'relative',
  ...
  return (
    <div style={ styles.picker } className={ 'base-picker' }>
...
export default CustomPicker(BaseColorPicker)