...
class ColorLinkComponent extends Component {
	constructor(props) {
		...
		let defaultParams = {
			colors: {
				'highlight': {
					tooltip: __( 'Initial', 'rebase' ),
					palette: true,
				},
				'highlight-alt': {
					tooltip: __( 'Hover', 'rebase' ),
					palette: true,
				},
				'highlight-alt2': {
					tooltip: __( 'Text Alt', 'rebase' ),
					palette: true,
				},
			},
			styles: {
				'standard': {
					label: __( 'Standard (underline)', 'rebase' ),
				},
				'color-underline': {
					label: __( 'Highlight Underline', 'rebase' ),
				},
				'no-underline': {
					label: __( 'No Underline', 'rebase' ),
				},
				'hover-background': {
					label: __( 'Background on Hover', 'rebase' ),
				},
				'offset-background': {
					label: __( 'Offset Background', 'rebase' ),
				},
			},
		};
