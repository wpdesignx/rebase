...
class MeasureComponent extends Component {
	...
	render() {
		...
		return (
			<div className="base-control-field base-range-control">
				{ this.controlParams.responsive && (
					<ResponsiveControl
					...
					>
						...
						<div className="base-units base-locked">
