...
class ColorComponent extends Component {
	constructor(props) {
		...
		let defaultParams = {
			...
			colors: {
				palette1: {
					tooltip: __( '1 - Accent', 'rebase' ),
					palette: false,
				},
				palette2: {
					tooltip: __( '2 - Accent - alt', 'rebase' ),
					palette: false,
				},
				palette3: {
					tooltip: __( '3 - Strongest text', 'rebase' ),
					palette: false,
				},
				palette4: {
					tooltip: __( '4 - Strong Text', 'rebase' ),
					palette: false,
				},
				palette5: {
					tooltip: __( '5 - Medium text', 'rebase' ),
					palette: false,
				},
				palette6: {
					tooltip: __( '6 - Subtle Text', 'rebase' ),
					palette: false,
				},
				palette7: {
					tooltip: __( '7 - Subtle Background', 'rebase' ),
					palette: false,
				},
				palette8: {
					tooltip: __( '8 - Lighter Background', 'rebase' ),
					palette: false,
				},
				palette9: {
					tooltip: __( '9 - White or offwhite', 'rebase' ),
					palette: false,
				},
			},
			paletteMap: {
				'palette': {
					'tooltip': __( 'Palette 1', 'rebase' ),
				},
				'second-palette': {
					'tooltip': __( 'Palette 2', 'rebase' ),
				},
				'third-palette': {
					'tooltip': __( 'Palette 3', 'rebase' ),
				}
			}
		};
	...
	render() {
		...
		return (
				<div className="base-control-field base-palette-control base-color-control">
					...
					<div className="base-palette-colors">
							...
							<Popover position="bottom right" className="base-palette-popover-copy-paste" onClose={ toggleClose }>
								<TabPanel className="base-palette-popover-tabs"
									...
									tabs={ [
										{
											name: 'import',
											title: __( 'Select a Color Set', 'rebase' ),
											className: 'base-color-presets',
										},
										{
											name: 'custom',
											title: __( 'Export/Import', 'rebase' ),
													...
													tabout = (
														<Fragment>
															...
															{ this.state.importError && (
																<p style={{color:'red'}}>{ __( 'Error with Import data', 'rebase') }</p>
															) }
															<Button
					...
					{ this.props.control.params.description && (
						<span className="customize-control-description"><a href="https://github.com/wpdesignx/rebase#color-palette" target="_blank">{ this.props.control.params.description }</a></span>
					) }
				</div>
		);
	}
