...
class BaseThemeLayout extends Component {
	...
	render() {
		...
		const titleOptions = {
			'default': {
				tooltip: __( 'Inherited Default', 'rebase' ),
				icon: 'inherit',
			},
			'hide': {
				tooltip: __( 'Hide Title', 'rebase' ),
				icon: 'hidetitle',
			},
			'normal': {
				tooltip: __( 'Show In Content', 'rebase' ),
				icon: 'incontent',
			},
			'above': {
				tooltip : __( 'Show Above Content', 'rebase' ),
				icon: 'abovecontent',
			},
		}
		...
		return (
			<Fragment>
				<PluginSidebarMoreMenuItem
					...
					icon={ icon }
				>
					{ baseMetaParams.post_type_name + ' ' + __( 'Settings', 'rebase' ) }
				</PluginSidebarMoreMenuItem>
				<PluginSidebar
					isPinnable={ true }
					icon={ icon }
					name="theme-meta-panel"
					title={ baseMetaParams.post_type_name + ' ' + __( 'Settings', 'rebase' ) }
				>
					<div className="base-sidebar-container components-panel__body is-opened">
						...
						/>
						<RadioIconComponent
							label={ baseMetaParams.post_type_name + ' ' + __( 'Title', 'rebase' ) }
							customClass="three-col-short"
						...
						/>
						<RadioIconComponent
							label={ baseMetaParams.post_type_name + ' ' + __( 'Layout', 'rebase' ) }
						...
						/>
						<RadioIconComponent
							label={ __( 'Content Vertical Padding', 'rebase' ) }
						...
						{ baseMetaParams.supports_feature && (
							<Fragment>
								<RadioIconComponent
									label={ __( 'Show Featured Image', 'rebase' ) }
								...
								{ ( ( undefined !== this.props.meta && undefined !== this.props.meta._bst_post_feature && 'show' === this.props.meta._bst_post_feature ) || ( undefined !== this.props.meta && undefined !== this.props.meta._bst_post_feature && 'default' === this.props.meta._bst_post_feature && 'show' === baseMetaParams.feature ) || ( undefined !== this.props.meta && undefined !== this.props.meta._bst_post_feature && '' === this.props.meta._bst_post_feature && 'show' === baseMetaParams.feature ) ) && (
									<RadioIconComponent
										label={ __( 'Featured Image Position', 'rebase' ) }
						...
						<ToggleControl
							label={ __( 'Disable Header', 'rebase' ) }
						...
						/>
						<ToggleControl
							label={ __( 'Disable Footer', 'rebase' ) }
