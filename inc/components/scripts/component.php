...
class Component implements Component_Interface {
	...
	public function ie_11_support_scripts() {
		if ( apply_filters( 'base_add_ie11_support', false ) || webapp()->option( 'ie11_basic_support' ) ) {
			wp_enqueue_style( 'base-ie11', get_theme_file_uri( '/assets/css/ie.min.css' ), array(), REBASE_VERSION );
			wp_enqueue_script(
				'base-css-vars-poly',
	...
	public function action_enqueue_scripts() {
		...
		wp_localize_script(
			...
			array(
				'of'    => __( 'of', 'rebase' ),
				'to'    => __( 'to', 'rebase' ),
				'slide' => __( 'Slide', 'rebase' ),
				'next'  => __( 'Next', 'rebase' ),
				'prev'  => __( 'Previous', 'rebase' ),
			)
		);
		...
		wp_localize_script(
			...
			array(
				'screenReader' => array(
					'expand'   => __( 'Expand child menu', 'rebase' ),
					'collapse' => __( 'Collapse child menu', 'rebase' ),
				),
				'breakPoints' => array(
