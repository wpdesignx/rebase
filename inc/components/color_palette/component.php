	...
	public function color_palette_register( $wp_customize ) {
		...
		$wp_customize->add_control(
			new Base_Control_Color_Palette(
				...
				'base_color_palette',
				array(
					'label'       => __( 'Global Palette', 'rebase' ),
					'description' => __( 'Learn how to use this', 'rebase' ),
