...
if ( class_exists( '\ElementorPro\Modules\DynamicTags\Tags\Base\Data_Tag' ) ) {
	...
	class Elementor_Dynamic_Colors extends \ElementorPro\Modules\DynamicTags\Tags\Base\Data_Tag {
		...
		public function get_title() {
			return __( 'Theme Color Palette', 'rebase' );
		}
		...
		protected function register_controls() {
			...
			$variables = array(
				'palette1' => __( '1 - Accent', 'rebase' ),
				'palette2' => __( '2 - Accent - alt', 'rebase' ),
				'palette3' => __( '3 - Strongest text', 'rebase' ),
				'palette4' => __( '4 - Strong Text', 'rebase' ),
				'palette5' => __( '5 - Medium text', 'rebase' ),
				'palette6' => __( '6 - Subtle Text', 'rebase' ),
				'palette7' => __( '7 - Subtle Background', 'rebase' ),
				'palette8' => __( '8 - Lighter Background', 'rebase' ),
				'palette9' => __( '9 - White or offwhite', 'rebase' ),
			);
			$this->add_control(
				'base_palette',
				array(
					'label' => __( 'Color', 'rebase' ),
