<?php
/**
 * Base\Zoom_Recipe_Card\Component class
 *
 * @package Base
 */

namespace Base\Zoom_Recipe_Card;
...
class Component implements Component_Interface {
	...
	public function zoom_recipe_card_styles() {
		wp_enqueue_style( 'base-zoom-recipe-card', get_theme_file_uri( '/assets/css/zoom-recipe-card.min.css' ), array(), REBASE_VERSION );
	}
}
