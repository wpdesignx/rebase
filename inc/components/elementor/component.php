...
class Component implements Component_Interface {
	...
	public function add_styles() {
		wp_enqueue_style( 'base-elementor', get_theme_file_uri( '/assets/css/elementor.min.css' ), array(), REBASE_VERSION );
	}
	/**
	...
	public function elementor_add_scripts() {
		if ( apply_filters( 'base_add_global_colors_to_elementor', true ) ) {
			wp_enqueue_style( 'base-elementor-admin', get_theme_file_uri( '/assets/css/elementor-admin.min.css' ), array(), REBASE_VERSION );
		}
	}
	/**
	...
	public function elementor_add_theme_color_controls( $tab, $args ) {
		if ( apply_filters( 'base_add_global_colors_to_elementor', true ) ) {
			$tab->start_controls_section(
				...
				array(
					'label' => __( 'Theme Global Colors', 'rebase' ),
					'tab' => 'global-colors',
				)
			);
